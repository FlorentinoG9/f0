...
import { useRosterAnnouncements } from "../../providers/useRosterAnnouncements"
 ...
 * screen reader.
 *
 * Joins, leaves and mode changes are produced here too — this is mounted once
 * for the life of the call, whichever mode it is in.
 */
export const MeetingLiveRegion = () => {
  const { liveMessage } = useMeetingSurface()
  useRosterAnnouncements()
