...
import { COMPACT_TILE_WIDTH, cellRadiusStyle } from "../../layout/constants"
...
export const OverflowTile = ({
  ...
  tiles: F0MeetingTile[]
  /**
   * The cell's width in px. The chip is one cell of the grid, so it goes
   * compact by the same rule as the tiles beside it — not by the window.
   */
  width: number
  /**
