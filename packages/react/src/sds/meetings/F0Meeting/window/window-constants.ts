 ...
 * draws: 158 + 44 + 48 = 250. Derived rather than written down: the old 282
 * was computed from "a 60px header and a 64px control bar" when the bar had
 * been 80px for a while, so the smallest window the user could reach still
 * had its video squeezed.
 */
