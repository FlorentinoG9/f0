...
/** The window as it first opens: the default size, in the bottom right. */
const placement = (
...
describe("resolvePlacement", () => {
  it("anchors to the bottom right", () => {
    ...
    expect(rect.x).toBe(1440 - 24 - WINDOW_DEFAULT_WIDTH)
    expect(rect.y).toBe(900 - 24 - WINDOW_DEFAULT_HEIGHT)
  })
