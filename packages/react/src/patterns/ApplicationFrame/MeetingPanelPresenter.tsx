...
export const MeetingPanelPresenter = (): null => {
  ...
  useEffect(() => {
    ...
    // The call leaving for a picture-in-picture window is not an eviction: it
    // took itself out of the panel and re-docks when the window closes.
    // Treating it as a loss would send it to `floating` instead.
  ...
  }, [isOurs, open, mode, effectiveMode, setMode])
