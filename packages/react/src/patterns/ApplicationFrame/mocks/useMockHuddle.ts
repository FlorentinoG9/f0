  ...
  const seed = useMemo(
    () =>
      seedFromAttendees({
        ...
        // You pressed a button to be in this call, so it captures the mic like
        // one — which is also what lets Chromium move it into
        // picture-in-picture when you switch tab.
