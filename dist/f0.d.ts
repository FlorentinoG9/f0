 ...
 */
export declare function BarChartSkeleton({ orientation, stacked, showLegend, }?: BarChartSkeletonProps): JSX.Element;
...
declare const CanvasCardAction: ({ action, isActive, }: Pick<F0CanvasCardProps, "action" | "isActive">) => JSX.Element | null;
...
declare const CanvasCardAvatar: ({ avatar }: Pick<F0CanvasCardProps, "avatar">) => JSX.Element | null;
...
declare const cardPropertyRenderers: {
    ...
    readonly folder: (args: FolderCellValue, meta: ValueDisplayRendererContext) => default_2.JSX.Element;
...
export declare function CollapsibleGroup({ label, threads, pinnedIds, onSelect, onPin, onUnpin, onDelete, }: CollapsibleGroupProps): JSX.Element;
 ...
 */
export declare const DataChartEmptyStateView: ({ emptyState, }: DataChartEmptyStateViewProps) => JSX.Element;
...
declare const DataList: ForwardRefExoticComponent<DataListProps & RefAttributes<HTMLUListElement>> & {
    ...
    }) => ReturnType<(<T_1 extends TagType_3>(props: TagListProps_2<T_1>, ref: ForwardedRef<HTMLLIElement>) => JSX.Element)>;
};
...
export declare const DropOverlay: ({ visible, onFilesDropped, mode, }: DropOverlayProps) => JSX.Element;
...
export declare function EmojiImage({ emoji, size, alt, mode, }: EmojiImageProps): JSX.Element;
...
Skeleton: ({ items, }: F0AccordionSkeletonProps) => JSX.Element;
}>;
...
export declare const F0ActionItem: ({ title, suffix, status, inGroup, }: F0ActionItemProps) => JSX.Element;
 ...
 * @experimental This is an experimental component use it at your own risk
 */
export declare const F0AiChat: ({ header: headerProp, messages: messagesProp, input: inputProp, overlay: overlayProp, }: F0AiChatProps) => JSX.Element | null;
 ...
 */
export declare const F0AiChatHeader: ({ historyEnabled, title, currentThreadTitle, fullscreen, lockVisualizationMode, onToggleVisualizationMode, onClose, onNewChat, onOpenHistory, hasMessages, credits, employeeCredits, compact, actions, }: F0AiChatHeaderProps) => JSX.Element;
 ...
 */
export declare const F0AiChatUsageLimitsButton: ({ usage, error, onOpenChange, trigger, side, }: F0AiChatUsageLimitsButtonProps) => JSX.Element;
...
export declare const F0AiMessagesContainer: (props: F0AiMessagesContainerProps) => JSX.Element;
 ...
 */
export declare function F0AiMessageSources({ sources, title: titleProp, }: F0AiMessageSourcesProps): JSX.Element | null;
...
export declare const F0AiPong: ({ onClose }: F0AiPongProps) => JSX.Element;
...
export declare function F0AiProposalCard(props: F0AiProposalCardProps): JSX.Element;
 ...
 * no AI coupling.
 */
export declare function F0AiTableCard({ dataset, title: titleProp, filename, }: F0AiTableCardProps): JSX.Element | null;
...
export declare const F0Alert: WithDataTestIdReturnType_3<({ title, description, action, link, icon, variant, onClose, }: F0AlertProps) => JSX.Element>;
...
export declare const F0AnalyticsDashboard: {
    <Filters extends FiltersDefinition_2 = FiltersDefinition_2>({ filters, presets, defaultFilters, filtersValue, onFiltersChange, items, itemFilters, editMode, onLayoutChange, enableExport, exportFilename, onExportReady, resetKey, onTransformChart, onAskAi, onAskAiTarget, navigationFilters, filtersLoading, }: F0AnalyticsDashboardProps_2<Filters>): JSX.Element;
    displayName: string;
};
...
export declare function F0AuraVoiceAnimation({ size, state, color, colorShift, audioTrack, themeMode, className, ref, ...props }: F0AuraVoiceAnimationProps & ComponentProps<"div"> & VariantProps<typeof F0AuraVoiceAnimationVariants>): JSX.Element;
...
export declare const F0AvatarAlert: WithDataTestIdReturnType_4<({ type, size, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, }: AlertAvatarProps_2) => JSX.Element>;

export declare const F0AvatarCompany: WithDataTestIdReturnType_4<    {
({ name, src, size, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, badge, }: F0AvatarCompanyProps_2): JSX.Element;
displayName: string;
}>;
...
export declare const F0AvatarDate: WithDataTestIdReturnType_4<({ date, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, }: F0AvatarDateProps) => JSX.Element>;

export declare const F0AvatarEmoji: WithDataTestIdReturnType_4<    {
({ emoji, size, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, }: F0AvatarEmojiProps_2): JSX.Element;
displayName: string;
}>;
...
({ icon, size, state, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, }: F0AvatarIconProps_2): JSX.Element;
displayName: string;
}>;
...
({ avatars, size, type, noTooltip, remainingCount: initialRemainingCount, max, tooltipScroll: _tooltipScroll, layout: _layout, }: F0AvatarListProps_2): JSX.Element;
displayName: string;
}>;
...
({ firstName, lastName, src, size, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, badge, deactivated, pending, }: F0AvatarPersonProps_2): JSX.Element;
displayName: string;
}>;
...
({ name, src, size, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, badge, }: F0AvatarTeamProps_2): JSX.Element;
displayName: string;
}>;
...
({ label, ...props }: BigNumberProps_2): JSX.Element;
displayName: string;
} & {
Skeleton: () => JSX.Element;
}>;

export declare const F0BookAMeetingCard: ({ onAction, actionHref, }: F0BookAMeetingCardProps) => JSX.Element;
...
export declare const F0ButtonDropdown: WithDataTestIdReturnType_6<(props: F0ButtonDropdownProps) => JSX.Element>;
 ...
 * @removeIn 5.0.0
 */
export declare function F0CanvasCard({ avatar, title, description, isActive, action, children, }: F0CanvasCardProps): JSX.Element;
...
declare function _F0Checkbox({ title, description, onCheckedChange, id, disabled, indeterminate, checked, value, hideLabel, presentational, stopPropagation, name, required, ...rest }: CheckboxProps): JSX.Element;
...
({ chips, max, remainingCount: initialRemainingCount, layout, }: Props): JSX.Element;
displayName: string;
}>;
 ...
 */
export declare const F0ClarifyingPanel: ({ clarifyingQuestion, isSubmitDisabled, }: F0ClarifyingPanelProps) => JSX.Element;
 ...
 * @experimental This is an experimental component use it at your own risk
 */
export declare const F0DataChart: (props: F0DataChartProps_2) => JSX.Element;
...
declare interface F0DataChartBaseProps extends F0DataChartCommonProps, F0DataChartLegendInteractionProps {
...
declare interface F0DataChartLegendInteractionProps {
    /**
 ...
 */
export declare interface F0DataChartPointClick {
...
export declare interface F0DataChartPointClickSeries {
 ...
 */
export declare interface F0DataChartRadarProps extends F0DataChartCommonProps, F0DataChartLegendInteractionProps {
    /** Chart type */
    type: "radar";
 ...
 */
export declare interface F0DataChartScatterProps extends F0DataChartCommonProps, F0DataChartLegendInteractionProps {
    /** Chart type */
    type: "scatter";
...
declare function F0DatePicker_2({ onChange, value, presets, granularities, minDate, maxDate, open, showIcon, displayFormat, selectOnCellOnly, ...inputProps }: F0DatePickerProps): JSX.Element;
...
export declare const F0DemoCard: ({ preview, moduleName, description, onAction, actionHref, }: F0DemoCardProps) => JSX.Element;
...
export declare const F0DialogAlikeContext: Context<F0DialogContextType>;

export declare const F0DialogAlikeProvider: ({ isOpen, onClose, shownBottomSheet, position, children, portalContainer, }: DialogWrapperProviderProps) => JSX.Element;
...
export declare const F0DialogProvider: ({ isOpen, onClose, shownBottomSheet, position, children, portalContainer, }: F0DialogProviderProps) => JSX.Element;
...
export declare const F0Drawer: {
    (props: F0DrawerProps): JSX.Element;
    displayName: string;
};
...
export declare const F0FAQCard: ({ headerIcon, items, defaultExpandedId, expandedId: controlledExpandedId, onExpandedChange, allowMultiple, }: F0FAQCardProps) => JSX.Element | null;
 ...
 * and file.
 */
export declare function F0FormField({ field, value, onChange, onBlur, error, errorMessage, status, loading, required, disabled, hideLabel: hideLabelProp, initialFiles, }: F0FormFieldProps): JSX.Element;
...
export declare namespace f0FormField {
    ...
    export type PhoneFieldShortcutConfig = Omit<F0PhoneFieldConfig, "fieldType"> & {
        optional?: boolean;
        /**
...
({ options, widgets, onChange, className, static: isStatic, forcePositionSync, }: F0GridStackProps_2): JSX.Element;
displayName: string;
}>;
 ...
 * @removeIn 5.0.0
 */
export declare const F0HILActionConfirmation: ({ text, description, avatar, confirmationText, onConfirm, cancelText, onCancel, stackAt, }: F0HILActionConfirmationProps) => JSX.Element;
...
export declare const F0ModuleCard: ({ moduleName, description, onAction, actionHref, imageSrc, }: F0ModuleCardProps) => JSX.Element;
...
export declare const F0OneSwitch: ({ className, disabled, onVisible, tooltip, autoOpen, onToggle, checked, onCheckedChange, }: F0OneSwitchProps) => JSX.Element | null;
...
export declare const F0QuestionCardMultiStep: ({ steps, onComplete, onSkip, sendAsMessage, onSendMessage, }: F0QuestionCardMultiStepProps) => JSX.Element | null;
...
export declare const F0Slider: ForwardRefExoticComponent<Omit<F0SliderProps_2 & RefAttributes<HTMLDivElement> & WithDataTestIdProps_2, "ref"> & RefAttributes<HTMLDivElement>> & Pick<ForwardRefExoticComponent<F0SliderProps_2 & RefAttributes<HTMLDivElement>>, never> & {
    Skeleton: ({ hideLabel }: F0SliderSkeletonProps) => JSX.Element;
};
 ...
 */
declare function F0TableOfContentPopover_2({ title, items, className, activeItem, collapsible, sortable, onReorder, showChildrenCounter, barsAlign, size, variant, portalContainer, }: F0TableOfContentPopoverProps): JSX.Element;
...
<T extends TagType_2>({ type, tags, max, remainingCount: initialRemainingCount, }: F0TagListProps<T>): JSX.Element;
displayName: string;
}>;
 ...
 * @experimental This is an experimental component use it at your own risk
 */
export declare const F0TimelineRow: WithDataTestIdReturnType_3<(props: F0TimelineRowProps_2) => JSX.Element>;
 ...
 */
declare function F0VideoPlayerInternal({ src, poster, ariaLabel, silent, persistControls, content, defaultLanguage, autoPlay, autoFocus, download, restrictForwardSeek, onTrackAction, onMilestone, onComplete, ...dataAttributes }: F0VideoPlayerProps): JSX.Element;
 ...
 */
export declare function FunnelChartSkeleton({ orient, sort, showLegend, }?: FunnelChartSkeletonProps): JSX.Element;
 ...
 */
export declare function GaugeChartSkeleton(): JSX.Element;
 ...
 */
export declare function HeatmapChartSkeleton(): JSX.Element;
...
declare type HourCycle = "12h" | "24h";
...
export declare const Layout: {
    ...
    <Widget extends GroupGridWidget_2, Deps extends Record<string, unknown> = Record<string, unknown>>({ widgets, editMode, onChange, WidgetWrapper, main, deps: dependencyValues, }: GroupGridProps_2<Widget, Deps>): JSX.Element;
    displayName: string;
    }>;
    GroupMasonry: WithDataTestIdReturnType_3<    {
    ({ blocks, sortable: _sortable, onSort: _onSort, main, }: GroupMasonryProps): JSX.Element;
    displayName: string;
    }>;
};
 ...
 */
export declare function LineChartSkeleton({ lineType, showArea, showDots, showLegend, }?: LineChartSkeletonProps): JSX.Element;
 ...
 */
declare type ListIconColor = ListIconPaletteColor | `#${string}`;
 ...
 */
declare const listIconColors: readonly ["viridian", "malibu", "yellow", "purple", "lilac", "barbie", "smoke", "army", "flubber", "indigo", "camel"];

declare type ListIconPaletteColor = (typeof listIconColors)[number];
 ...
 */
export declare function PieChartSkeleton({ showLegend, innerRadius, }?: PieChartSkeletonProps): JSX.Element;
...
export declare function PongBall({ size, className, style }: PongBallProps): JSX.Element;
...
declare function _ProductCard({ title, description, onClick, onClose, isVisible, dismissable, trackVisibility, type, ...props }: ProductCardProps): false | JSX.Element;
...
declare function _ProductModal({ isOpen, onClose, title, image, benefits, errorMessage, successMessage, loadingState, nextSteps, closeLabel, primaryAction, modalTitle, modalModule, secondaryAction, portalContainer, tag, promoTag, showResponseDialog, }: ProductModalProps): JSX.Element;
...
declare function _ProductWidget({ mediaUrl, title, description, onClose, dismissible, width, trackVisibility, actions, showConfirmation, }: ProductWidgetProps): JSX.Element;
 ...
 */
export declare function RadarChartSkeleton({ showLegend, }?: RadarChartSkeletonProps): JSX.Element;
...
export declare function ScatterChartSkeleton({ showLegend, }?: ScatterChartSkeletonProps): JSX.Element;
...
export declare function SurveyAllQuestionsLoadingSkeleton(): JSX.Element;

export declare function SurveyAnsweringForm(props: SurveyAnsweringFormProps): JSX.Element;
...
export declare const SurveyFormBuilder: WithDataTestIdReturnType_8<({ elements: elementsProp, disabled, onChange, disallowOptionalQuestions, allowedQuestionTypes, applyingChanges, useUpload, datasets, placeholders, labels, skipDefaultSection, }: SurveyFormBuilderProps) => JSX.Element>;
 ...
 * form fields.
 */
export declare function SurveySampleQuestion(props: SurveySampleQuestionProps): JSX.Element;

export declare type SurveySampleQuestionProps = SampleRatingQuestion | SampleChoiceQuestion;

export declare function SurveySteppedLoadingSkeleton(): JSX.Element;
...
export declare const TagCounter: {
    ({ count, list }: Props_3): JSX.Element;
    displayName: string;
};
...
export declare function ThreadItem({ thread, isPinned, isActive, isPending, onSelect, onPin, onUnpin, onDelete, className, }: ThreadItemProps): JSX.Element;
 ...
 * appear on hover).
 */
export declare function ThreadListSkeleton(): JSX.Element;
...
export declare const ToastProvider: ({ children, portalTargets, }: ToastProviderProps) => JSX.Element;
...
declare function _UpsellingAlert({ icon, title, description, action, onDismiss, }: UpsellingAlertProps): JSX.Element;
...
declare function _UpsellingButton({ label, showIcon, onRequest, showConfirmation, loading: externalLoading, errorMessage, successMessage, loadingState, nextSteps, closeLabel, variant, onModalStateChange, portalContainer, ...props }: UpsellingButtonProps): JSX.Element;
...
declare function _UpsellingPopover({ isOpen, setIsOpen, label, variant, size, showIcon, side, align, icon, mediaUrl, title, description, width, trackVisibility, actions, onClick, hideLabel, }: UpsellingPopoverProps): JSX.Element;
...
export declare const useAudioPlayer: (audioRef: RefObject<HTMLAudioElement | null>, callbacks?: UseAudioPlayerCallbacks, initialDuration?: number) => AudioPlayerControls;
 ...
 */
export declare const useDerivedTranscription: (audioRef: RefObject<HTMLAudioElement | null>, currentSrc: string | undefined, enabled: boolean) => string | undefined;
...
export declare const useEmojiConfetti: () => {
    fireEmojiConfetti: (emoji: string, elementRef: RefObject<HTMLElement | null>) => void;
};
...
export declare const useF0DialogAlikeContext: () => F0DialogContextType;
...
declare const valueDisplayRenderers: {
    readonly text: (args: TextCellValue_2, meta: ValueDisplayRendererContext_2) => JSX.Element;
    readonly longText: (args: LongTextCellValue, meta: ValueDisplayRendererContext_2) => JSX.Element;
    readonly number: (args: NumberCellValue_2, meta: ValueDisplayRendererContext_2) => JSX.Element;
    readonly date: (args: DateCellValue_2, meta: ValueDisplayRendererContext_2) => JSX.Element;
    readonly amount: (args: AmountCellValue_2, meta: ValueDisplayRendererContext_2) => JSX.Element;
    readonly compound: (args: CompoundCellValue, meta: ValueDisplayRendererContext_2) => JSX.Element;
    readonly avatarList: (args: AvatarListCellValue_2, meta: ValueDisplayRendererContext_2) => JSX.Element;
    readonly status: (args: StatusCellValue_2) => JSX.Element;
    readonly alertTag: (args: AlertTagCellValue_2) => JSX.Element;
    readonly person: (args: PersonCellValue_2, meta: ValueDisplayRendererContext_2) => JSX.Element;
    readonly percentage: (args: PercentageCellValue, meta: ValueDisplayRendererContext_2) => JSX.Element | null;
    readonly progressBar: (args: ProgressBarCellValue_2, _meta?: ValueDisplayRendererContext_2) => JSX.Element | null;
    readonly progressSeries: (args: ProgressSeriesCellValue, meta: ValueDisplayRendererContext_2) => JSX.Element;
    readonly barSeries: (args: BarSeriesCellValue, meta: ValueDisplayRendererContext_2) => JSX.Element;
    readonly categoryBarChart: (args: CategoryBarChartCellValue, meta: ValueDisplayRendererContext_2) => JSX.Element;
    readonly hourDistribution: (args: HourDistributionCellValue_2, meta: ValueDisplayRendererContext_2) => JSX.Element;
    readonly company: (args: CompanyCellValue_2, meta: ValueDisplayRendererContext_2) => JSX.Element;
    readonly team: (args: TeamCellValue_2, meta: ValueDisplayRendererContext_2) => JSX.Element;
    readonly tag: (args: TagCellValue_2) => JSX.Element;
    readonly dotTag: (args: DotTagCellValue_2) => JSX.Element;
    readonly tagList: (args: TagListCellValue_2) => JSX.Element;
    readonly icon: (args: IconCellValue, meta: ValueDisplayRendererContext_2) => JSX.Element;
    readonly file: (args: FileCellValue_2) => JSX.Element;
    readonly folder: (args: FolderCellValue_2, meta: ValueDisplayRendererContext_2) => JSX.Element;
    readonly country: (args: CountryCellValue, context: ValueDisplayRendererContext_2) => JSX.Element;
    readonly delta: (args: DeltaCellValue) => JSX.Element;
    readonly summary: (args: SummaryCellValue, meta: ValueDisplayRendererContext_2) => JSX.Element;
    readonly count: (args: CountCellValue, meta: ValueDisplayRendererContext_2) => JSX.Element;
};
 ...
 */
declare interface ViewportInset {
    top?: number;
    right?: number;
    bottom?: number;
    left?: number;
