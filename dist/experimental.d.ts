 ...
 * @experimental This is an experimental component use it at your own risk
 */
export declare const AiPromotionChat: WithDataTestIdReturnType_2<() => JSX.Element | null>;

export declare const AiPromotionChatProvider: WithDataTestIdReturnType_2<({ enabled, greeting, title, description, benefits, actions, onShow, onHide, children, }: AiPromotionChatProviderProps) => JSX.Element>;
...
declare function _ApplicationFrame({ children, sidebar, banner, ai, aiPromotion, sidePanel, meeting, }: ApplicationFrameProps): JSX.Element;
 ...
 * @experimental This is an experimental component use it at your own risk
 */
export declare const Badge: WithDataTestIdReturnType_2<({ type, size, icon }: BadgeProps) => JSX.Element>;
...
export declare const BaseCelebration: ({ link, firstName, lastName, src, onClick, canReact, lastEmojiReaction, onReactionSelect, type, typeLabel, date, }: CelebrationProps) => JSX.Element;
...
declare function BaseHeader({ title, avatar, deactivated, description, primaryAction, secondaryActions, otherActions, status, metadata, metadataRowGap, showBottomBorder, onClose, }: BaseHeaderProps_2): JSX.Element;
 ...
 * ```
 */
export declare function Breadcrumbs({ breadcrumbs, append }: BreadcrumbsProps): JSX.Element;

export declare function BreadcrumbSelect<T extends string, R = unknown>({ ...props }: BreadcrumbSelectProps<T, R>): JSX.Element;
 ...
 * long roster.
 */
export declare const buildTiles: (participants: F0MeetingParticipant[]) => F0MeetingTile[];
...
declare const cardPropertyRenderers: {
    ...
    readonly folder: (args: FolderCellValue_2, meta: ValueDisplayRendererContext_2) => default_2.JSX.Element;
...
export declare function CategoryBarSection({ title, subtitle, data, helpText, legend, hideTooltip, }: CategoryBarSectionProps): JSX.Element;
...
export declare const Celebration: (({ link, firstName, lastName, src, onClick, canReact, lastEmojiReaction, onReactionSelect, type, typeLabel, date, }: CelebrationProps) => JSX.Element) & {
...
export declare const CelebrationSkeleton: () => JSX.Element;
 ...
 * @experimental This is an experimental component use it at your own risk
 */
export declare const Chip: ({ deactivated, label, variant, onClick, onClose, avatar, icon, }: ChipProps) => JSX.Element;
 ...
 */
export declare const CoachmarkProvider: ({ children, portalTarget, }: CoachmarkProviderProps) => JSX.Element;
...
export declare const CommunityPost: (({ id, author, group, createdAt, title, description, onClick, mediaUrl, event, counters, reactions, inLabel, comment, actions, dropdownItems, noReactionsButton, descriptionExpandable, noDescriptionClamp, hideTitle, hideGroup, pinned, pinnedLabel, relativeDate, }: CommunityPostProps) => JSX.Element) & {
    Skeleton: ({ withEvent, withImage, }: CommunityPostSkeletonProps) => JSX.Element;
};
...
export declare const CommunityPostSkeleton: ({ withEvent, withImage, }: CommunityPostSkeletonProps) => JSX.Element;
...
export declare function CompanySelector({ companies, selected, onChange, isLoading, withNotification, additionalOptions, variant, }: CompanySelectorProps): JSX.Element;
...
declare function _Counter({ size, type, value, maxValue }: CounterProps): JSX.Element;
 ...
 */
export declare const createMeetingSignalStore: () => MeetingSignalStore;
...
declare const DataList: ForwardRefExoticComponent<DataListProps & RefAttributes<HTMLUListElement>> & {
    ...
    }) => ReturnType<(<T_1 extends TagType>(props: TagListProps<T_1>, ref: ForwardedRef<HTMLLIElement>) => JSX.Element)>;
};
...
declare function _DaytimePage({ children, header, period, embedded, hideOneSwitch, }: DaytimePageProps): JSX.Element;
...
declare const defaultTranslations: {
    ...
    readonly meeting: {
        ...
        readonly controls: "Meeting controls";
        ...
        readonly exitPictureInPicture: "Back to the tab";
        ...
        readonly movedToFullscreen: "Meeting fills the screen";
        readonly movedToFloating: "Meeting in a floating window";
        readonly movedToSidePanel: "Meeting in the side panel";
        readonly movedToMinimized: "Meeting minimized";
        readonly movedInline: "Meeting on the page";
        readonly movedToPictureInPicture: "Meeting in a picture-in-picture window";
    };
    readonly select: {
...
export declare const F0AiBanner: ForwardRefExoticComponent<Omit<AiBannerInternalProps & RefAttributes<HTMLDivElement> & WithDataTestIdProps_2, "ref"> & RefAttributes<HTMLDivElement>> & Pick<ForwardRefExoticComponent<AiBannerInternalProps & RefAttributes<HTMLDivElement>>, never> & {
    Skeleton: ({ compact }: AiBannerSkeletonProps) => JSX.Element;
};
...
onClose?: never;
    ...
    Skeleton: ({ status, compact }: AiCalloutSkeletonProps) => JSX.Element;
};
...
declare const F0AvatarAlert: WithDataTestIdReturnType_3<({ type, size, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, }: AlertAvatarProps_2) => JSX.Element>;
 ...
 */
declare function F0AvatarModule_2({ size, module, ...props }: F0AvatarModuleProps): JSX.Element;
...
declare const F0AvatarPulse: {
    ({ firstName, lastName, src, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, pulse, onPulseClick, }: F0AvatarPulseProps): JSX.Element;
    displayName: string;
};
...
export declare const F0Callout: ForwardRefExoticComponent<Omit<CalloutInternalProps & RefAttributes<HTMLDivElement> & WithDataTestIdProps_2, "ref"> & RefAttributes<HTMLDivElement>> & Pick<ForwardRefExoticComponent<CalloutInternalProps & RefAttributes<HTMLDivElement>>, never> & {
    Skeleton: ({ compact, variant }: CalloutSkeletonProps) => JSX.Element;
};
 ...
 * @experimental This is an experimental component use it at your own risk
 */
export declare const F0CarouselDialog: WithDataTestIdReturnType_2<({ items, currentId, onNavigate, labels, loop, pagination, placeholder, isOpen, onClose, ...dialogProps }: F0CarouselDialogProps) => JSX.Element | null>;
...
export declare type F0ChatItem = F0ChatMessage | F0ChatSystemMessage | F0ChatPost | F0ChatCallMessage;
 ...
 */
export declare const F0CommandPaletteProvider: ({ children, groups, recent, assistant, labels, onNavigate, shortcut, open: openProp, onOpenChange, }: F0CommandPaletteProviderProps_2) => JSX.Element;
 ...
 */
export declare const F0CommunityPostsCarousel: ({ posts, labels, loading, expectedItemsCount, pagination, }: F0CommunityPostsCarouselProps) => JSX.Element;
...
({ label, value, defaultValue, onChange, clearable, disabled, locale, size, }: F0EmojiPickerProps_2): JSX.Element;
displayName: string;
}>;
...
({ value, onChange, labels, icons, size, fullWidth, disabled, required, }: F0ENPSButtonProps_2): JSX.Element;
displayName: string;
}>;
...
export declare interface F0MapProps extends WithDataTestIdProps {
    ...
    /** Rendering engine to draw the map with. */
 ...
 */
export declare const F0MapSkeleton: ({ dataTestId, className, }: F0MapSkeletonProps) => JSX.Element;
 ...
 */
export declare const F0Meeting: ({ runtime, actions, actionOrder, defaultMode, pictureInPicture, sidePanel, headerContent, overlay, children, }: F0MeetingProviderProps) => ReactNode;

export declare type F0MeetingAction = {
    /**
...
export declare type F0MeetingActionInput = F0MeetingAction | F0MeetingActionPatch;
 ...
 */
export declare type F0MeetingActionPatch = Partial<Omit<F0MeetingAction, "id">> & {
    id: F0MeetingCoreActionId;
};

export declare type F0MeetingActionsProp = F0MeetingActionInput[] | ((runtime: F0MeetingRuntime) => F0MeetingActionInput[]);
 ...
 */
export declare type F0MeetingBinding = (element: HTMLMediaElement) => () => void;
 ...
 */
export declare type F0MeetingCapabilities = {
...
export declare const f0MeetingConnectionQualities: readonly ["excellent", "good", "poor", "lost"];

export declare type F0MeetingConnectionQuality = (typeof f0MeetingConnectionQualities)[number];

export declare type F0MeetingCoreActionId = (typeof f0MeetingCoreActionIds)[number];

export declare const f0MeetingCoreActionIds: readonly ["core:microphone", "core:microphoneSettings", "core:camera", "core:cameraSettings", "core:screenShare", "core:raiseHand", "core:chat", "core:leave"];

export declare type F0MeetingDevice = {
...
export declare type F0MeetingDisconnectReason = (typeof f0MeetingDisconnectReasons)[number];

export declare const f0MeetingDisconnectReasons: readonly ["user-left", "removed", "room-closed", "duplicate-identity", "server-shutdown", "connection-lost", "unknown"];
 ...
 */
export declare type F0MeetingFocusIntent = {
    type: "auto";
} | {
    type: "pinned";
    key: string;
 ...
 */
export declare type F0MeetingLocalMedia = {
...
export declare type F0MeetingLocalSource = {
    enabled: boolean;
...
export declare type F0MeetingParticipant = {
    id: string;
 ...
 */
export declare type F0MeetingPermission = (typeof f0MeetingPermissions)[number];

export declare const f0MeetingPermissions: readonly ["granted", "prompt", "denied", "unavailable", "in-use"];

export declare type F0MeetingPresence = (typeof f0MeetingPresences)[number];
 ...
 */
export declare const f0MeetingPresences: readonly ["invited", "joined"];
 ...
 */
export declare const F0MeetingProvider: ({ runtime, children, }: {
    /**
...
export declare type F0MeetingProviderProps = {
    ...
    /**
     * Whether the browser may move the call into its picture-in-picture window
     * when the user leaves the tab. On by default. There is no button for it,
     * and nothing happens on a browser without either PiP API.
     */
...
export declare type F0MeetingReaction = {
    id: string;
...
export declare type F0MeetingRecording = {
    active: boolean;
 ...
 */
export declare const F0MeetingRoom: ({ actions, actionOrder, sidePanel, overlay, }: F0MeetingRoomProps) => JSX.Element;

export declare type F0MeetingRoomInfo = {
    id: string;
...
export declare type F0MeetingRoomProps = {
    actions?: F0MeetingActionsProp;
    actionOrder?: string[];
    sidePanel?: F0MeetingSidePanel;
    overlay?: React.ReactNode;
...
export declare type F0MeetingRoster = {
 ...
 */
export declare type F0MeetingRuntime = {
    room: F0MeetingRoomInfo;
    status: F0MeetingStatus;
...
export declare type F0MeetingSidePanel = {
 ...
 */
export declare type F0MeetingSidePanelTab = {
    id: string;
    label: string;
 ...
 */
export declare type F0MeetingSignal = {
 ...
 */
export declare type F0MeetingSignalStore = {
 ...
 */
export declare const F0MeetingSlot: () => JSX.Element;
 ...
 */
export declare type F0MeetingStable = {
    roomId: string;
    localParticipantId: string;
    capabilities?: F0MeetingCapabilities;
    /**
 ...
 */
export declare type F0MeetingStatus = (typeof f0MeetingStatuses)[number];

export declare const f0MeetingStatuses: readonly ["idle", "connecting", "connected", "reconnecting", "disconnected", "error"];
 ...
 */
export declare const F0MeetingSurface: () => JSX.Element | null;

export declare type F0MeetingSurfaceDestination = (typeof f0MeetingSurfaceDestinations)[number];

/** The places a call can be sent to — by the user, or by `defaultMode`. */
export declare const f0MeetingSurfaceDestinations: readonly ["fullscreen", "panel", "floating", "minimized", "inline"];

export declare type F0MeetingSurfaceMode = (typeof f0MeetingSurfaceModes)[number];

/**
 * Everything the surface can render as. `pip` is the one mode nobody chooses:
 * the browser moves the call into its picture-in-picture window when the tab
 * is left, whatever mode it was in, and closing that window returns to it.
 * Never persisted, never a `defaultMode`, never a button.
 */
export declare const f0MeetingSurfaceModes: readonly ["fullscreen", "panel", "floating", "minimized", "inline", "pip"];
 ...
 */
export declare type F0MeetingTile = {
...
export declare type F0MeetingTrack = {
...
export declare type F0MeetingTrackKind = (typeof f0MeetingTrackKinds)[number];

export declare const f0MeetingTrackKinds: readonly ["camera", "microphone", "screenShare", "screenShareAudio"];
 ...
 */
export declare type F0MeetingTranscriptSegment = {
...
export declare const F0NotesTextEditor: ForwardRefExoticComponent<F0NotesTextEditorProps & RefAttributes<F0NotesTextEditorHandle>> & {
    Skeleton: ({ withHeader, withTitle, withToolbar, }: F0NotesTextEditorSkeletonProps) => JSX.Element;
};
...
export declare const F0NotesTextEditorSkeleton: ({ withHeader, withTitle, withToolbar, }: F0NotesTextEditorSkeletonProps) => JSX.Element;
 ...
 */
declare const F0ResourceHeader: ({ avatar, title, description, primaryAction, secondaryActions, otherActions, status, metadata, deactivated, metadataRowGap, showBottomBorder, onClose, }: Props) => JSX.Element;
...
export declare const F0RichTextEditor: ForwardRefExoticComponent<F0RichTextEditorProps & RefAttributes<F0RichTextEditorHandle>> & {
    Skeleton: ({ rows, }: F0RichTextEditorSkeletonProps) => JSX.Element;
};
...
export declare const F0SegmentedControl: {
    ({ items, value, onChange, disabled, fullWidth, hideLabels, ariaLabel, ariaLabelledBy, }: F0SegmentedControlProps_2): JSX.Element;
    displayName: string;
};
...
declare function _F0TableOfContent(props: TOCProps): JSX.Element;
...
declare function _F0VersionHistory({ title, versions, currentVersion, activeVersionId, }: F0VersionHistoryProps): JSX.Element;
...
export declare type F0WindowCorner = (typeof f0WindowCorners)[number];

export declare const f0WindowCorners: readonly ["tl", "tr", "bl", "br"];
 ...
 */
export declare type F0WindowPlacement = {
...
export declare type GridSolution = {
    rows: number;
...
export declare type GridSolverInput = {
    count: number;
    width: number;
    height: number;
    gap: number;
...
export declare const HighlightBanner: ({ title, subtitle, buttonLabel, onClick, }: HighlightBannerProps) => JSX.Element;
 ...
 */
export declare const HomeSlotItem: ({ className, animated, children, }: HomeSlotItemProps) => JSX.Element;
...
declare type IconAvatarVariant = Extract<AvatarVariant, {
    type: "icon";
}>;
...
declare const Input_2: React_2.ForwardRefExoticComponent<Omit<React_2.InputHTMLAttributes<HTMLInputElement>, "onChange" | "size"> & Pick<InputFieldProps<string>, "label" | "onChange" | "size" | "icon" | "role" | "onFocus" | "onBlur" | "transparent" | "status" | "loading" | "hint" | "disabled" | "error" | "required" | "append" | "hideLabel" | "maxLength" | "isEmpty" | "labelIcon" | "onClickContent" | "readonly" | "clearable" | "autocomplete" | "onClear" | "emptyValue" | "hideMaxLength" | "appendTag" | "lengthProvider" | "buttonToggle"> & React_2.RefAttributes<HTMLInputElement>>;
...
export declare function Item({ item, counter, isActive, collapsible, isExpanded, onToggleExpanded, sortable, children, onDragOver, onDragLeave, onDrop, canDropInside, currentParentId, justDropped, }: TOCItemProps): JSX.Element;
...
export declare function ItemSectionHeader({ item, children, isActive, collapsible, isExpanded, onToggleExpanded, sortable, hideChildrenCounter, canDropInside, onDragOver, onDragLeave, onDrop, currentParentId, draggedItemId, }: TOCItemSectionHeaderProps): JSX.Element;
 ...
 */
export declare const layoutGrid: (solution: GridSolution, box: {
    width: number;
    height: number;
}, gap: number) => F0Rect[];
 ...
 */
export declare const MeetingNotes: ({ value, onChange }: MeetingNotesProps) => JSX.Element;

declare type MeetingNotesProps = {
    value: string;
 ...
 */
export declare const MeetingRoomChat: ({ messages, onSend }: MeetingRoomChatProps) => JSX.Element;

declare type MeetingRoomChatMessage = {
    id: string;
    participantId: string;
    text: string;
    at: string;
...
declare type MeetingRoomChatProps = {
 ...
 * on reveal.
 */
export declare const MeetingSidePanel: ({ panel }: MeetingSidePanelProps) => JSX.Element | null;

declare type MeetingSidePanelProps = {
    panel: F0MeetingSidePanel;
};

export declare type MeetingSignalStore = F0MeetingSignalStore & {
    setAudioLevel: (participantId: string, level: number) => void;
    setSpeaking: (participantIds: readonly string[]) => void;
    setQuality: (participantId: string, quality: F0MeetingConnectionQuality) => void;
...
export declare const MeetingSurfaceProvider: ({ defaultMode, roomId, pictureInPicture, children, }: {
    defaultMode?: F0MeetingSurfaceDestination;
 ...
 */
export declare const MeetingTranscript: ({ segments }: MeetingTranscriptProps) => JSX.Element;

declare type MeetingTranscriptProps = {
...
export declare function Menu({ tree, onCollapse, onSort, onFavoritesChange, favorites, }: MenuProps): JSX.Element;
 ...
 * @experimental This is an experimental component use it at your own risk
 */
export declare const MobileDropdown: ({ items, children, dataTestId }: DropdownProps) => JSX.Element;
...
export declare const nearestCorner: (rect: F0Rect, viewport: Viewport) => F0WindowCorner;
...
export declare const NotesTextEditorSkeleton: ({ withHeader, withTitle, withToolbar, }: F0NotesTextEditorSkeletonProps) => JSX.Element;
...
declare function _OmniButton({ label, options, hasNewUpdate }: OmniButtonProps): JSX.Element;
...
(props: OneCalendarProps): JSX.Element;
displayName: string;
}>;

export declare const OneCalendarInternal: ({ mode, view, onSelect, defaultMonth, defaultSelected, showNavigation, showInput, minDate, maxDate, compact, weekStartsOn, selectOnCellOnly, periods, }: OneCalendarInternalProps) => JSX.Element;
...
declare function _OneDateNavigator({ onSelect, defaultValue, presets, granularities, hideNavigation, hideGoToCurrent, compareTo, defaultCompareTo, onCompareToChange, value, dataTestId, periods, ...props }: OneDatePickerProps): JSX.Element;
...
declare function _OneEmptyState({ title, description, variant, emoji, actions, ...rest }: Types.OneEmptyStateProps): JSX.Element;
...
declare function _OnePagination({ totalPages, currentPage, onPageChange, showControls, ariaLabel, visibleRange, hasNextPage, disabled, }: OnePaginationProps): JSX.Element;
...
declare function _Page({ children, header, embedded }: PageProps): JSX.Element;
...
export declare function PageHeader({ module, statusTag, breadcrumbs, actions, embedded, navigation, productUpdates, favorites, oneSwitchTooltip, oneSwitchAutoOpen, hideOneSwitch, }: HeaderProps_2): JSX.Element;
...
export declare function PageNavigation({ previous, next, counter }: NavigationProps): JSX.Element;
...
declare type PipSupport = "document" | "video" | "none";

/** Re-expresses an absolute rect against a given corner. */
export declare const placementFromRect: (rect: F0Rect, corner: F0WindowCorner, viewport: Viewport) => F0WindowPlacement;

declare type PopoverContentProps = React_2.ComponentPropsWithoutRef<typeof PopoverPrimitive.Content> & {
    /** Portal target. Defaults to the nearest `PortalContainerProvider`. */
    container?: HTMLElement | null;
};
...
declare function _Reactions({ items, onInteraction, locale, action }: ReactionsProps): JSX.Element;
 ...
 */
export declare const reorderForSpeakers: ({ tiles, speakerIds, pageSize, lastSpokenAt, now, holdMs, }: SpeakerOrderInput) => F0MeetingTile[];
 ...
 */
export declare const resolveAutoFocus: ({ tiles, intent, seenShareKeys, }: AutoFocusInput) => AutoFocusResult;
 ...
 */
export declare const resolvePlacement: (placement: F0WindowPlacement, viewport: Viewport, minWidth?: number, minHeight?: number) => F0Rect;
...
export declare function SearchBar({ onClick, placeholder, shortcut, ...props }: SearchBarProps): JSX.Element;
 ...
 * @experimental This is an experimental component use it at your own risk
 */
export declare const SectionHeader: ({ title, description, action, link, separator, }: Props_2) => JSX.Element;
 ...
 */
export declare const settlePlacement: (rect: F0Rect, viewport: Viewport) => F0WindowPlacement;
...
declare function _Shortcut({ keys, variant }: ShortcutProps): JSX.Element | null;
...
declare function _Sidebar({ header, body, footer, onFooterDropdownClick, rail, }: SidebarProps): JSX.Element;
...
export declare const SidebarChatProvider: ({ children, initialGroups, initialActiveChatId, }: SidebarChatProviderProps) => JSX.Element;
 ...
 */
export declare const SidebarCollapsibleSection: ({ title, isOpen: initialIsOpen, isRoot, onCollapse, children, highlightWhenCollapsed, collapsedBadge, action, isDragging, wasDragging, }: SidebarCollapsibleSectionProps) => JSX.Element;
...
export declare function SidebarFooter({ user, options, showActivityButton, activityButtonShortcut, onActivityButtonClick, onDropdownClick, hasActivityUpdates, }: SidebarFooterProps): JSX.Element;
...
export declare function SidebarHeader({ companies, selected, onChange, withNotification, additionalOptions, isLoading, }: SidebarHeaderProps): JSX.Element;
 ...
 */
export declare function SidebarPanelHeader({ title, actions, }: SidebarPanelHeaderProps): JSX.Element;

export declare type SidebarPanelHeaderProps = {
    /**
 ...
 */
export declare function SidebarRail({ company, tabs, activeTab, onTabChange, persistKey, onActiveTabPress, actions, user, }: SidebarRailProps): JSX.Element;
 ...
 */
export declare const SidebarTabPanel: ({ groups, actions, searchPlaceholder, loading, skeleton, emptyState, noResultsLabel, animateItems, className, }: SidebarTabPanelProps) => JSX.Element;
 ...
 */
export declare const SidebarTabs: ({ tabs, activeTab, onTabChange, persistKey, }: SidebarTabsProps) => JSX.Element;
...
export declare type SidebarUser = {
    firstName: string;
    lastName: string;
    avatarUrl?: string;
};
 ...
 */
export declare function SidebarUserMenu({ user, options, onDropdownClick, compact, }: SidebarUserMenuProps): JSX.Element;

export declare type SidebarUserMenuProps = {
    user: SidebarUser;
    options: DropdownItem[];
    onDropdownClick?: () => void;
    /**
...
export declare function SlotWidget({ header, params, fullHeight, action, summaries, headerControls, headerActions, headerSelect, alert, status, slots, loading, slotRenderers, actions, flipped, onFlipBack, isDragging, ctx, }: SlotWidgetProps): JSX.Element;
 ...
 */
export declare function SlotWidgetContent({ slots, loading, slotRenderers, ctx, }: Pick<SlotWidgetProps, "slots" | "loading" | "slotRenderers" | "ctx">): JSX.Element;
 ...
 */
export declare const solveGrid: (input: GridSolverInput) => GridSolution;
 ...
 */
export declare const solveSpotlight: ({ stripCount, width, height, gap, stripRange, spotlightRange, }: SpotlightSolverInput) => SpotlightSolution;
...
declare type SpeakerOrderInput = {
    tiles: F0MeetingTile[];
...
declare function _Spinner({ size, className }: SpinnerProps): JSX.Element;
...
export declare type SpotlightSolution = {
    spotlight: F0Rect;
    strip: F0Rect[];
...
export declare type SpotlightSolverInput = {
...
declare function _Switch({ title, onCheckedChange, id, disabled, checked, value, hideLabel, presentational, required, ...rest }: SwitchProps): JSX.Element;
...
declare function TableHead({ children, width, minWidth, sortState, onSortClick, onClick, info, infoIcon, sticky, hidden, highlighted, align, className, colSpan, }: TableHeadProps): JSX.Element;
...
export declare function TasksList({ tasks, onClickTask, hideIcons, maxTasksToShow, emptyMessage, }: TasksListProps): JSX.Element;

declare function TasksList({ tasks, onClickTask, hideIcons, maxTasksToShow, emptyMessage, }: TasksListProps): JSX.Element;
...
maxHeight?: number;
} & Pick<InputFieldProps<string>, "label" | "value" | "onChange" | "size" | "icon" | "onFocus" | "onBlur" | "onKeyDown" | "status" | "loading" | "hint" | "placeholder" | "error" | "required" | "hideLabel" | "maxLength" | "labelIcon" | "clearable" | "onClear"> & RefAttributes<HTMLTextAreaElement>>;
...
export declare const tileAspectRatio: (tile: F0MeetingTile, fallback: number) => number;

export declare const tileKey: (participantId: string, kind: string) => string;
 ...
 * of sentences.
 */
declare type TooltipListItem = string | {
    title: string;
    description?: string;
};
...
export declare const useF0Meeting: () => F0MeetingRuntime;
...
export declare const useInfiniteScrollPagination: (paginationInfo: PaginationInfo | null, isLoading: boolean, isLoadingMore: boolean, loadMore: () => void) => {
    loadingIndicatorRef: RefObject<HTMLTableCellElement | null>;
};
 ...
 */
export declare function useMeetingSignal(participantId: string): F0MeetingSignal;

export declare function useMeetingSignal<T>(participantId: string, selector: (signal: F0MeetingSignal) => T, isEqual?: (previous: T, next: T) => boolean): T;

/** The set of currently speaking participants, for the layout's ordering. */
export declare const useMeetingSpeakers: () => readonly string[];

export declare const useMeetingSurface: () => MeetingSurfaceContextValue;
 ...
 */
export declare const useMeetingSurfaceOptional: () => MeetingSurfaceContextValue | null;
 ...
 */
export declare const useTrackBinding: <T extends HTMLMediaElement>(track: F0MeetingTrack | undefined) => React.RefObject<T | null>;
...
declare const valueDisplayRenderers: {
    readonly text: (args: TextCellValue, meta: ValueDisplayRendererContext) => JSX.Element;
    readonly longText: (args: LongTextCellValue, meta: ValueDisplayRendererContext) => JSX.Element;
    readonly number: (args: NumberCellValue, meta: ValueDisplayRendererContext) => JSX.Element;
    readonly date: (args: DateCellValue, meta: ValueDisplayRendererContext) => JSX.Element;
    readonly amount: (args: AmountCellValue, meta: ValueDisplayRendererContext) => JSX.Element;
    readonly compound: (args: CompoundCellValue, meta: ValueDisplayRendererContext) => JSX.Element;
    readonly avatarList: (args: AvatarListCellValue, meta: ValueDisplayRendererContext) => JSX.Element;
    readonly status: (args: StatusCellValue) => JSX.Element;
    readonly alertTag: (args: AlertTagCellValue) => JSX.Element;
    readonly person: (args: PersonCellValue, meta: ValueDisplayRendererContext) => JSX.Element;
    readonly percentage: (args: PercentageCellValue, meta: ValueDisplayRendererContext) => JSX.Element | null;
    readonly progressBar: (args: ProgressBarCellValue, _meta?: ValueDisplayRendererContext) => JSX.Element | null;
    readonly progressSeries: (args: ProgressSeriesCellValue, meta: ValueDisplayRendererContext) => JSX.Element;
    readonly barSeries: (args: BarSeriesCellValue, meta: ValueDisplayRendererContext) => JSX.Element;
    readonly categoryBarChart: (args: CategoryBarChartCellValue, meta: ValueDisplayRendererContext) => JSX.Element;
    readonly hourDistribution: (args: HourDistributionCellValue, meta: ValueDisplayRendererContext) => JSX.Element;
    readonly company: (args: CompanyCellValue, meta: ValueDisplayRendererContext) => JSX.Element;
    readonly team: (args: TeamCellValue, meta: ValueDisplayRendererContext) => JSX.Element;
    readonly tag: (args: TagCellValue) => JSX.Element;
    readonly dotTag: (args: DotTagCellValue) => JSX.Element;
    readonly tagList: (args: TagListCellValue) => JSX.Element;
    readonly icon: (args: IconCellValue, meta: ValueDisplayRendererContext) => JSX.Element;
    readonly file: (args: FileCellValue) => JSX.Element;
    readonly folder: (args: FolderCellValue, meta: ValueDisplayRendererContext) => JSX.Element;
    readonly country: (args: CountryCellValue, context: ValueDisplayRendererContext) => JSX.Element;
    readonly delta: (args: DeltaCellValue) => JSX.Element;
    readonly summary: (args: SummaryCellValue, meta: ValueDisplayRendererContext) => JSX.Element;
    readonly count: (args: CountCellValue, meta: ValueDisplayRendererContext) => JSX.Element;
};
...
declare const VerticalOverflowList: {
    <T>({ items, renderListItem, className, gap, minSize, onVisibleItemsChange, }: OverflowListProps<T>): JSX.Element;
    displayName: string;
};
...
export declare const viewportRect: (viewport: Viewport) => F0Rect;
...
export declare function WidgetAvatarsListItem({ id, title, subtitle, avatars, remainingCount, withPointerCursor, onClick, ...props }: WidgetAvatarsListItemProps): JSX.Element;
 ...
 */
export declare function WidgetCatalog({ isOpen, onClose, widgets, onAdd, groups, area, previewWidth, slotRenderers, rebuildPreview, title, }: WidgetCatalogProps): JSX.Element;
...
declare function _WidgetEmptyState({ title, description, emoji, actions, }: WidgetEmptyStateProps): JSX.Element;
...
export declare function WidgetHighlightButton({ label, count, icon, iconClassName, onClick, }: Props_7): JSX.Element;

export declare function WidgetInboxList({ items, minSize, onClickItem, showAllItems, onVisibleItemsChange, }: Props_9): JSX.Element;

export declare function WidgetInboxListItem({ id, title, subtitle, onClick, module, }: Props_8): JSX.Element;
...
export declare function WidgetSimpleList({ items, gap, minSize, onClickItem, showAllItems, }: Props_10): JSX.Element;

export declare function WidgetSimpleListItem({ id, title, alert, rawTag, count, icon, rightIcon, iconClassName, rightIconClassName, onClick, }: WidgetSimpleListItemProps): JSX.Element;
