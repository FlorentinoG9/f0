...
declare const CanvasCardAction: ({ action, isActive, }: Pick<F0CanvasCardProps, "action" | "isActive">) => JSX | null;
...
declare const CanvasCardAvatar: ({ avatar }: Pick<F0CanvasCardProps, "avatar">) => JSX | null;
...
export declare function CollapsibleGroup({ label, threads, pinnedIds, onSelect, onPin, onUnpin, onDelete, }: CollapsibleGroupProps): JSX;
...
declare const DataList: ForwardRefExoticComponent<DataListProps & RefAttributes<HTMLUListElement>> & {
    ...
    }) => ReturnType<(<T_1 extends TagType>(props: TagListProps<T_1>, ref: ForwardedRef<HTMLLIElement>) => JSX)>;
};
...
export declare const DropOverlay: ({ visible, onFilesDropped, mode, }: DropOverlayProps) => JSX;
...
export declare const F0ActionItem: ({ title, suffix, status, inGroup, }: F0ActionItemProps) => JSX;
 ...
 */
export declare const F0AiChat: ({ header: headerProp, messages: messagesProp, input: inputProp, overlay: overlayProp, }: F0AiChatProps) => JSX | null;
 ...
 */
export declare const F0AiChatHeader: ({ historyEnabled, title, currentThreadTitle, fullscreen, lockVisualizationMode, onToggleVisualizationMode, onClose, onNewChat, onOpenHistory, hasMessages, credits, employeeCredits, compact, actions, }: F0AiChatHeaderProps) => JSX;
 ...
 */
export declare const F0AiChatUsageLimitsButton: ({ usage, error, onOpenChange, trigger, side, }: F0AiChatUsageLimitsButtonProps) => JSX;
...
export declare const F0AiMessagesContainer: (props: F0AiMessagesContainerProps) => JSX;
 ...
 */
export declare function F0AiMessageSources({ sources, title: titleProp, }: F0AiMessageSourcesProps): JSX | null;
...
export declare const F0AiPong: ({ onClose }: F0AiPongProps) => JSX;
...
export declare function F0AiProposalCard(props: F0AiProposalCardProps): JSX;
 ...
 * no AI coupling.
 */
export declare function F0AiTableCard({ dataset, title: titleProp, filename, }: F0AiTableCardProps): JSX | null;
...
export declare function F0AuraVoiceAnimation({ size, state, color, colorShift, audioTrack, themeMode, className, ref, ...props }: F0AuraVoiceAnimationProps & ComponentProps<"div"> & VariantProps<typeof F0AuraVoiceAnimationVariants>): JSX;
 ...
 * @removeIn 5.0.0
 */
export declare function F0CanvasCard({ avatar, title, description, isActive, action, children, }: F0CanvasCardProps): JSX;
 ...
 */
export declare const F0ClarifyingPanel: ({ clarifyingQuestion, isSubmitDisabled, }: F0ClarifyingPanelProps) => JSX;
 ...
 * @removeIn 5.0.0
 */
export declare const F0HILActionConfirmation: ({ text, description, avatar, confirmationText, onConfirm, cancelText, onCancel, stackAt, }: F0HILActionConfirmationProps) => JSX;
...
export declare const F0OneSwitch: ({ className, disabled, onVisible, tooltip, autoOpen, onToggle, checked, onCheckedChange, }: F0OneSwitchProps) => JSX | null;
...
export declare function PongBall({ size, className, style }: PongBallProps): JSX;
...
export declare function ThreadItem({ thread, isPinned, isActive, isPending, onSelect, onPin, onUnpin, onDelete, className, }: ThreadItemProps): JSX;
 ...
 * appear on hover).
 */
export declare function ThreadListSkeleton(): JSX;
