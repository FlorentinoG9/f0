import { jsx as O, Fragment as Sn, jsxs as On } from "react/jsx-runtime";
import * as d from "react";
import { useLayoutEffect as Tn, useEffect as kn, useContext as Ln, createContext as Mn } from "react";
...
function Pt(e) {
  ...
  if (typeof e == "string" || typeof e == "number") o += e;
    ...
    var r = e.length;
    for (t = 0; t < r; t++) e[t] && (n = Pt(e[t])) && (o && (o += " "), o += n);
  } else for (n in e) e[n] && (o && (o += " "), o += n);
  return o;
}
function Dn() {
  for (var e, t, n = 0, o = "", r = arguments.length; n < r; n++) (e = arguments[n]) && (t = Pt(e)) && (o && (o += " "), o += t);
  return o;
}
const Ye = "-", _n = (e) => {
  const t = zn(e), {
  ...
  return {
    getClassGroupId: (i) => {
      const a = i.split(Ye);
      return a[0] === "" && a.length !== 1 && a.shift(), At(a, t) || In(i);
    },
  ...
  const n = e[0], o = t.nextPart.get(n), r = o ? At(e.slice(1), o) : void 0;
  if (r)
    return r;
  ...
  return Fn(Object.entries(e.classGroups), n).forEach(([s, i]) => {
    We(i, o, s, t);
  }), o;
}, We = (e, t, n, o) => {
  e.forEach((r) => {
...
}, $n = (e) => e.isThemeGetter, Fn = (e, t) => t ? e.map(([n, o]) => {
  ...
  const {
    ...
    const m = c.length === 0 ? a : a.substring(u), p = m.startsWith(Et), g = p ? m.substring(1) : m, h = f && f > u ? f - u : void 0;
    return {
      modifiers: c,
  ...
  for (let c = i.length - 1; c >= 0; c -= 1) {
    ...
    const b = Bn(u).join(":"), y = f ? b + Et : b, w = y + h;
    if (s.includes(w))
      continue;
    s.push(w);
    const x = r(h, g);
...
function Yn(e, ...t) {
  ...
  function i(c) {
    ...
    return n = Vn(l), o = n.cache.get, r = n.cache.set, s = a, a(c);
  }
  function a(c) {
    const l = o(c);
    if (l)
...
const M = (e) => {
...
}, St = /^\[(?:([a-z-]+):)?(.+)\]$/i, Xn = /^\d+\/\d+$/, qn = /* @__PURE__ */ new Set(["px", "full", "screen"]), Kn = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, Zn = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, Jn = /^(rgba?|hsla?|hwb|(ok)?(lab|lch))\(.+\)$/, Qn = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, eo = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, K = (e) => ce(e) || qn.has(e) || Xn.test(e), ee = (e) => fe(e, "length", co), ce = (e) => !!e && !Number.isNaN(Number(e)), ze = (e) => fe(e, "number", ce), he = (e) => !!e && Number.isInteger(Number(e)), to = (e) => e.endsWith("%") && ce(e.slice(0, -1)), E = (e) => St.test(e), te = (e) => Kn.test(e), no = /* @__PURE__ */ new Set(["length", "size", "percentage"]), oo = (e) => fe(e, no, Ot), ro = (e) => fe(e, "position", Ot), so = /* @__PURE__ */ new Set(["image", "url"]), io = (e) => fe(e, so, uo), ao = (e) => fe(e, "", lo), be = () => !0, fe = (e, t, n) => {
  const o = St.exec(e);
  ...
  Zn.test(e) && !Jn.test(e)
), Ot = () => !1, lo = (e) => Qn.test(e), uo = (e) => eo.test(e), fo = () => {
  const e = M("colors"), t = M("spacing"), n = M("blur"), o = M("brightness"), r = M("borderColor"), s = M("borderRadius"), i = M("borderSpacing"), a = M("borderWidth"), c = M("contrast"), l = M("grayscale"), u = M("hueRotate"), f = M("invert"), m = M("gap"), p = M("gradientColorStops"), g = M("gradientColorStopPositions"), h = M("inset"), b = M("margin"), y = M("opacity"), w = M("padding"), x = M("saturate"), v = M("scale"), P = M("sepia"), A = M("skew"), C = M("space"), L = M("translate"), z = () => ["auto", "contain", "none"], T = () => ["auto", "hidden", "clip", "visible", "scroll"], $ = () => ["auto", E, t], R = () => [E, t], D = () => ["", K, ee], k = () => ["auto", ce, E], F = () => ["bottom", "center", "left", "left-bottom", "left-top", "right", "right-bottom", "right-top", "top"], N = () => ["solid", "dashed", "dotted", "double", "none"], _ = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], S = () => ["start", "end", "center", "between", "around", "evenly", "stretch"], I = () => ["", "0", E], W = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], V = () => [ce, E];
  return {
    cacheSize: 500,
    separator: ":",
    theme: {
      ...
      gradientColorStopPositions: [to, ee],
      inset: $(),
      margin: $(),
      opacity: V(),
      padding: R(),
    ...
    classGroups: {
       ...
       */
      leading: [{
        leading: ["none", "tight", "snug", "normal", "relaxed", "loose", K, E]
      }],
      /**
       * List Style Image
...
// @__NO_SIDE_EFFECTS__
function Mt(e) {
  const t = /* @__PURE__ */ go(e), n = d.forwardRef((o, r) => {
    const { children: s, ...i } = o, a = d.Children.toArray(s), c = a.find(bo);
    if (c) {
...
var $s = /* @__PURE__ */ Mt("Slot");
// @__NO_SIDE_EFFECTS__
function go(e) {
  const t = d.forwardRef((n, o) => {
    const { children: r, ...s } = n;
    if (d.isValidElement(r)) {
      const i = wo(r), a = yo(s, r.props);
...
// @__NO_SIDE_EFFECTS__
function ho(e) {
  const t = ({ children: n }) => /* @__PURE__ */ O(Sn, { children: n });
...
var Po = "DismissableLayer", He = "dismissableLayer.update", Ao = "dismissableLayer.pointerDownOutside", Eo = "dismissableLayer.focusOutside", lt, Dt = d.createContext({
  ...
  (e, t) => {
    const {
      ...
      onDismiss: a,
      ...c
    } = e, l = d.useContext(Dt), [u, f] = d.useState(null), m = u?.ownerDocument ?? globalThis?.document, [, p] = d.useState({}), g = ae(t, (C) => f(C)), h = Array.from(l.layers), [b] = [...l.layersWithOutsidePointerEventsDisabled].slice(-1), y = h.indexOf(b), w = u ? h.indexOf(u) : -1, x = l.layersWithOutsidePointerEventsDisabled.size > 0, v = w >= y, P = Oo((C) => {
...
_t.displayName = Po;
var Ro = "DismissableLayerBranch", So = d.forwardRef((e, t) => {
...
function To(e, t = globalThis?.document) {
  ...
  return d.useEffect(() => {
    const r = (s) => {
      s.target && !o.current && It(Eo, n, { originalEvent: s }, {
        discrete: !1
      });
    };
...
function It(e, t, n, { discrete: o }) {
  ...
  t && r.addEventListener(e, t, { once: !0 }), o ? xo(r, s) : r.dispatchEvent(s);
}
var ne = globalThis?.document ? d.useLayoutEffect : () => {
}, ko = d[" useId ".trim().toString()] || (() => {
}), Lo = 0;
function Mo(e) {
  const [t, n] = d.useState(ko());
  return ne(() => {
    n((o) => o ?? String(Lo++));
  }, [e]), t ? `radix-${t}` : "";
}
const No = ["top", "right", "bottom", "left"], oe = Math.min, H = Math.max, Re = Math.round, Pe = Math.floor, Y = (e) => ({
  x: e,
  y: e
}), Do = {
  left: "right",
...
const dt = ["left", "right"], ft = ["right", "left"], Fo = ["top", "bottom"], Wo = ["bottom", "top"];
function Ho(e, t, n) {
  switch (e) {
    case "top":
    case "bottom":
...
async function jo(e, t) {
  ...
  const {
    ...
    x: 1,
    y: 1
  }, P = Oe(s.convertOffsetParentRelativeRectToViewportRelativeRect ? await s.convertOffsetParentRelativeRectToViewportRelativeRect({
    elements: a,
    rect: w,
    offsetParent: x,
    strategy: c
  ...
  return {
    top: (y.top - P.top + g.top) / v.y,
    bottom: (P.bottom - y.bottom + g.bottom) / v.y,
    left: (y.left - P.left + g.left) / v.x,
    right: (P.right - y.right + g.right) / v.x
  };
}
const Go = async (e, t, n) => {
  ...
  for (let b = 0; b < a.length; b++) {
    ...
    const {
      ...
      platform: {
        ...i,
        detectOverflow: (h = i.detectOverflow) != null ? h : jo
      },
      elements: {
        reference: e,
        floating: t
    ...
    }, A && g <= 50 && (g++, typeof A == "object" && (A.placement && (m = A.placement), A.rects && (l = A.rects === !0 ? await i.getElementRects({
      reference: e,
      floating: t,
      strategy: r
    }) : A.rects), {
  ...
  async fn(t) {
    ...
    const f = zt(u), m = {
      x: n,
      y: o
    }, p = Ke(r), g = qe(p), h = await i.getDimensions(l), b = p === "y", y = b ? "top" : "left", w = b ? "bottom" : "right", x = b ? "clientHeight" : "clientWidth", v = s.reference[g] + s.reference[p] - m[p] - s.floating[g], P = m[p] - s.reference[p], A = await (i.getOffsetParent == null ? void 0 : i.getOffsetParent(l));
    let C = A ? A[x] : 0;
    (!C || !await (i.isElement == null ? void 0 : i.isElement(A))) && (C = a.floating[x] || s.floating[g]);
    const L = v / 2 - P / 2, z = C / 2 - h[g] / 2 - 1, T = oe(f[y], z), $ = oe(f[w], z), R = T, D = C - h[g] - $, k = C / 2 - h[g] / 2 + L, F = Be(R, k, D), N = !c.arrow && pe(r) != null && k !== F && s.reference[g] / 2 - (k < R ? T : $) - h[g] / 2 < 0, _ = N ? k < R ? k - R : k - D : 0;
    return {
      [p]: m[p] + _,
      data: {
        [p]: F,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = s.arrow) != null && n.alignmentOffset)
        return {};
      const y = Q(r), w = U(a), x = Q(a) === a, v = await (c.isRTL == null ? void 0 : c.isRTL(l.floating)), P = m || (x || !h ? [Se(a)] : $o(a)), A = g !== "none";
      !m && A && P.push(...Bo(a, h, g, v));
      const C = [a, ...P], L = await c.detectOverflow(t, b), z = [];
...
const Ko = function(e) {
  ...
  return e === void 0 && (e = {}), {
    ...
    fn(t) {
      ...
      if (c) {
        const x = m === "y" ? "height" : "width", v = s.reference[m] - s.floating[x] + b.mainAxis, P = s.reference[m] + s.reference[x] - b.mainAxis;
        p < v ? p = v : p > P && (p = P);
      }
      if (l) {
        var y, w;
        const x = m === "y" ? "width" : "height", v = $t.has(Q(r)), P = s.reference[f] - s.floating[x] + (v && ((y = i.offset) == null ? void 0 : y[f]) || 0) + (v ? 0 : b.crossAxis), A = s.reference[f] + s.reference[x] + (v ? 0 : ((w = i.offset) == null ? void 0 : w[f]) || 0) - (v ? b.crossAxis : 0);
        g < P ? g = P : g > A && (g = A);
      }
      return {
        [m]: p,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      const w = h - u.top - u.bottom, x = g - u.left - u.right, v = oe(h - u[b], w), P = oe(g - u[y], x), A = !t.middlewareData.shift;
      let C = v, L = P;
      if ((n = t.middlewareData.shift) != null && n.enabled.x && (L = x), (o = t.middlewareData.shift) != null && o.enabled.y && (C = w), A && !m) {
...
const er = /* @__PURE__ */ new Set(["inline", "contents"]);
function ve(e) {
  const {
    overflow: t,
    overflowX: n,
  ...
  return /auto|scroll|overlay|hidden|clip/.test(t + o + n) && !er.has(r);
}
...
const rr = ["transform", "translate", "scale", "rotate", "perspective"], sr = ["transform", "translate", "scale", "rotate", "perspective", "filter"], ir = ["paint", "layout", "strict", "content"];
function Ze(e) {
  const t = Je(), n = j(e) ? G(e) : e;
  return rr.some((o) => n[o] ? n[o] !== "none" : !1) || (n.containerType ? n.containerType !== "normal" : !1) || !t && (n.backdropFilter ? n.backdropFilter !== "none" : !1) || !t && (n.filter ? n.filter !== "none" : !1) || sr.some((o) => (n.willChange || "").includes(o)) || ir.some((o) => (n.contain || "").includes(o));
}
function ar(e) {
  let t = re(e);
  for (; X(t) && !ue(t); ) {
...
const cr = /* @__PURE__ */ new Set(["html", "body", "#document"]);
function ue(e) {
  return cr.has(me(e));
}
function G(e) {
...
const lr = /* @__PURE__ */ Y(0);
function Bt(e) {
  const t = B(e);
  return !Je() || !t.visualViewport ? lr : {
...
function br(e, t) {
  ...
  for (; j(i) && !ue(i); ) {
    const a = G(i), c = Ze(i);
    !c && a.position === "fixed" && (r = null), (s ? !c && !r : !c && a.position === "static" && !!r && gr.has(r.position) || ve(i) && !c && jt(e, i)) ? o = o.filter((u) => u !== i) : r = a, i = re(i);
  }
  return t.set(e, o), o;
}
function yr(e) {
  ...
  const i = [...n === "clippingAncestors" ? Me(t) ? [] : br(t, this._c) : [].concat(n), o], a = i[0], c = i.reduce((l, u) => {
    const f = yt(t, u, r);
...
function Gt(e, t) {
  ...
  for (; o && nr(o) && $e(o); )
    o = wt(o, t);
  return o && ue(o) && $e(o) && !Ze(o) ? n : o || ar(e) || n;
}
...
function Ar(e, t) {
  ...
  function i(a, c) {
    ...
    if (a || t(), !m || !p)
      return;
    const g = Pe(f), h = Pe(r.clientWidth - (u + m)), b = Pe(r.clientHeight - (f + p)), y = Pe(u), x = {
...
const Rr = Ko, Sr = Zo, Or = Yo, Tr = Qo, kr = Xo, vt = Uo, Lr = Jo, Mr = (e, t, n) => {
...
var Ee = typeof document < "u" ? Tn : kn;
function Te(e, t) {
  if (e === t)
    return !0;
...
function Nr(e) {
  ...
  const [g, h] = d.useState(null), [b, y] = d.useState(null), w = d.useCallback((S) => {
  ...
  }, []), v = s || g, P = i || b, A = d.useRef(null), C = d.useRef(null), L = d.useRef(u), z = c != null, T = Fe(c), $ = Fe(r), R = Fe(l), D = d.useCallback(() => {
    ...
    $.current && (S.platform = $.current), Mr(A.current, C.current, S).then((I) => {
      const W = {
        ...I,
  ...
  Ee(() => (k.current = !0, () => {
    ...
    if (v && (A.current = v), P && (C.current = P), v && P) {
      if (T.current)
        return T.current(v, P, D);
      D();
    }
  }, [v, P, D, T, z]);
  const F = d.useMemo(() => ({
...
var Br = "Arrow", Xt = d.forwardRef((e, t) => {
...
var et = "Popper", [qt, Kt] = Lt(et), [Gr, Zt] = qt(et), Jt = (e) => {
  const { __scopePopper: t, children: n } = e, [o, r] = d.useState(null);
  return /* @__PURE__ */ O(Gr, { scope: t, anchor: o, onAnchorChange: r, children: n });
};
Jt.displayName = et;
...
en.displayName = Qt;
var tt = "PopperContent", [Ur, Yr] = qt(tt), tn = d.forwardRef(
  (e, t) => {
    const {
      __scopePopper: n,
      side: o = "bottom",
      ...
      onPlaced: g,
      ...h
    } = e, b = Zt(tt, n), [y, w] = d.useState(null), x = ae(t, (ge) => w(ge)), [v, P] = d.useState(null), A = jr(v), C = A?.width ?? 0, L = A?.height ?? 0, z = o + (s !== "center" ? "-" + s : ""), T = typeof u == "number" ? u : { top: 0, right: 0, bottom: 0, left: 0, ...u }, $ = Array.isArray(l) ? l : [l], R = $.length > 0, D = {
      padding: T,
      boundary: $.filter(qr),
      // with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
      altBoundary: R
    }, { refs: k, floatingStyles: F, placement: N, isPositioned: _, middlewareData: S } = Nr({
      // default to `fixed` strategy so users don't have to pick and we also avoid focus scroll issues
      strategy: "fixed",
      placement: z,
      whileElementsMounted: (...ge) => Er(...ge, {
      ...
      middleware: [
        _r({ mainAxis: r + L, alignmentAxis: i }),
        c && Ir({
          mainAxis: !0,
          crossAxis: !1,
        ...
        Fr({
          ...D,
          apply: ({ elements: ge, rects: st, availableWidth: Pn, availableHeight: An }) => {
            const { width: En, height: Rn } = st.reference, Ce = ge.floating.style;
            Ce.setProperty("--radix-popper-available-width", `${Pn}px`), Ce.setProperty("--radix-popper-available-height", `${An}px`), Ce.setProperty("--radix-popper-anchor-width", `${En}px`), Ce.setProperty("--radix-popper-anchor-height", `${Rn}px`);
          }
        }),
        v && Hr({ element: v, padding: a }),
        Kr({ arrowWidth: C, arrowHeight: L }),
        m && Wr({ strategy: "referenceHidden", ...D })
      ]
    }), [I, W] = rn(N), V = ke(g);
    ne(() => {
      _ && V?.();
    }, [_, V]);
    const yn = S.arrow?.x, wn = S.arrow?.y, vn = S.arrow?.centerOffset !== 0, [xn, Cn] = d.useState();
    return ne(() => {
...
tn.displayName = tt;
var nn = "PopperArrow", Xr = {
  top: "bottom",
  right: "left",
  bottom: "top",
  left: "right"
}, on = d.forwardRef(function(t, n) {
  const { __scopePopper: o, ...r } = t, s = Yr(nn, o), i = Xr[s.placedSide];
  return (
...
var Zr = Jt, Jr = en, Qr = tn, es = on, ts = "Portal", sn = d.forwardRef((e, t) => {
  const { container: n, ...o } = e, [r, s] = d.useState(!1);
  ne(() => s(!0), []);
  const i = n || r && globalThis?.document?.body;
  return i ? Nn.createPortal(/* @__PURE__ */ O(se.div, { ...o, ref: t }), i) : null;
});
sn.displayName = ts;
function ns(e, t) {
...
var nt = (e) => {
  const { present: t, children: n } = e, o = os(t), r = typeof n == "function" ? n({ present: o.isPresent }) : d.Children.only(n), s = ae(o.ref, rs(r));
  return typeof n == "function" || o.isPresent ? d.cloneElement(r, { ref: s }) : null;
};
nt.displayName = "Presence";
function os(e) {
  const [t, n] = d.useState(), o = d.useRef(null), r = d.useRef(e), s = d.useRef("none"), i = e ? "mounted" : "unmounted", [a, c] = ns(i, {
    mounted: {
      UNMOUNT: "unmounted",
  ...
  return d.useEffect(() => {
    ...
    if (t) {
      ...
      const u = t.ownerDocument.defaultView ?? window, f = (p) => {
        const h = Ae(o.current).includes(CSS.escape(p.animationName));
        ...
        p.target === t && (s.current = Ae(o.current));
      };
...
var ss = d[" useInsertionEffect ".trim().toString()] || ne;
function is({
  prop: e,
  defaultProp: t,
  onChange: n = () => {
...
var ls = Object.freeze({
  ...
  whiteSpace: "nowrap",
  wordWrap: "normal"
}), us = "VisuallyHidden", an = d.forwardRef(
  (e, t) => /* @__PURE__ */ O(
    se.span,
    {
      ...e,
...
an.displayName = us;
var ds = an, [_e] = Lt("Tooltip", [
  Kt
]), Ie = Kt(), cn = "TooltipProvider", fs = 700, Ge = "tooltip.open", [ps, ot] = _e(cn), ln = (e) => {
  const {
    __scopeTooltip: t,
    delayDuration: n = fs,
...
ln.displayName = cn;
var we = "Tooltip", [ms, xe] = _e(we), un = (e) => {
  const {
    __scopeTooltip: t,
    children: n,
    open: o,
    ...
    delayDuration: a
  } = e, c = ot(we, e.__scopeTooltip), l = Ie(t), [u, f] = d.useState(null), m = Mo(), p = d.useRef(0), g = i ?? c.disableHoverableContent, h = a ?? c.delayDuration, b = d.useRef(!1), [y, w] = is({
    prop: o,
    defaultProp: r ?? !1,
    onChange: (C) => {
  ...
  }, []), /* @__PURE__ */ O(Zr, { ...l, children: /* @__PURE__ */ O(
    ms,
    {
      scope: t,
      contentId: m,
      ...
      onTriggerEnter: d.useCallback(() => {
        c.isOpenDelayedRef.current ? A() : v();
      }, [c.isOpenDelayedRef, A, v]),
      onTriggerLeave: d.useCallback(() => {
        g ? P() : (window.clearTimeout(p.current), p.current = 0);
      }, [P, g]),
      onOpen: v,
      onClose: P,
...
var Ue = "TooltipTrigger", dn = d.forwardRef(
  (e, t) => {
    ...
    return d.useEffect(() => () => document.removeEventListener("pointerup", f), [f]), /* @__PURE__ */ O(Jr, { asChild: !0, ...i, children: /* @__PURE__ */ O(
      se.button,
      {
...
dn.displayName = Ue;
var rt = "TooltipPortal", [gs, hs] = _e(rt, {
  forceMount: void 0
}), fn = (e) => {
  const { __scopeTooltip: t, forceMount: n, children: o, container: r } = e, s = xe(rt, t);
  return /* @__PURE__ */ O(gs, { scope: t, forceMount: n, children: /* @__PURE__ */ O(nt, { present: n || s.open, children: /* @__PURE__ */ O(sn, { asChild: !0, container: r, children: o }) }) });
};
fn.displayName = rt;
var de = "TooltipContent", pn = d.forwardRef(
  (e, t) => {
    const n = hs(de, e.__scopeTooltip), { forceMount: o = n.forceMount, side: r = "top", ...s } = e, i = xe(de, e.__scopeTooltip);
    return /* @__PURE__ */ O(nt, { present: o || i.open, children: i.disableHoverableContent ? /* @__PURE__ */ O(mn, { side: r, ...s, ref: t }) : /* @__PURE__ */ O(bs, { side: r, ...s, ref: t }) });
  }
), bs = d.forwardRef((e, t) => {
  const n = xe(de, e.__scopeTooltip), o = ot(de, e.__scopeTooltip), r = d.useRef(null), s = ae(t, r), [i, a] = d.useState(null), { trigger: c, onClose: l } = n, u = r.current, { onPointerInTransitChange: f } = o, m = d.useCallback(() => {
    ...
    (g, h) => {
      const b = g.currentTarget, y = { x: g.clientX, y: g.clientY }, w = Cs(y, b.getBoundingClientRect()), x = Ps(y, w), v = As(h.getBoundingClientRect()), P = Rs([...x, ...v]);
      a(P), f(!0);
    },
    [f]
  );
  return d.useEffect(() => () => m(), [m]), d.useEffect(() => {
    ...
    if (i) {
      const g = (h) => {
        const b = h.target, y = { x: h.clientX, y: h.clientY }, w = c?.contains(b) || u?.contains(b), x = !Es(y, i);
        w ? m() : x && (m(), l());
      };
      return document.addEventListener("pointermove", g), () => document.removeEventListener("pointermove", g);
    }
  }, [c, u, i, l, m]), /* @__PURE__ */ O(mn, { ...e, ref: s });
}), [ys, ws] = _e(we, { isInside: !1 }), vs = /* @__PURE__ */ ho("TooltipContent"), mn = d.forwardRef(
  (e, t) => {
    const {
      __scopeTooltip: n,
      children: o,
      ...
      _t,
      {
        ...
        children: /* @__PURE__ */ On(
          Qr,
          {
            ...
            children: [
              /* @__PURE__ */ O(vs, { children: o }),
              /* @__PURE__ */ O(ys, { scope: n, isInside: !0, children: /* @__PURE__ */ O(ds, { id: c.contentId, role: "tooltip", children: r || o }) })
            ]
          }
        )
      }
...
pn.displayName = de;
var gn = "TooltipArrow", xs = d.forwardRef(
  (e, t) => {
    const { __scopeTooltip: n, ...o } = e, r = Ie(n);
    return ws(
      gn,
      n
    ).isInside ? null : /* @__PURE__ */ O(es, { ...r, ...o, ref: t });
  }
);
xs.displayName = gn;
function Cs(e, t) {
...
function Rs(e) {
  const t = e.slice();
  return t.sort((n, o) => n.x < o.x ? -1 : n.x > o.x ? 1 : n.y < o.y ? -1 : n.y > o.y ? 1 : 0), Ss(t);
}
function Ss(e) {
...
var Os = ln, Ts = un, ks = dn, Ls = fn, hn = pn;
const bn = Mn(null), Fs = ({
  container: e,
  children: t
}) => /* @__PURE__ */ O(bn.Provider, { value: e, children: t }), Ms = () => Ln(bn), Ws = Os, Hs = Ts, Bs = ks, Ns = d.forwardRef(({ className: e, sideOffset: t = 4, ...n }, o) => {
  const r = Ms();
  return /* @__PURE__ */ O(Ls, { container: r ?? void 0, children: /* @__PURE__ */ O(
    hn,
    {
      ref: o,
      sideOffset: t,
