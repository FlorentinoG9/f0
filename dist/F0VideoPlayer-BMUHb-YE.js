...
function ce({
  ...
  return /* @__PURE__ */ S(tt, { children: [
    /* @__PURE__ */ S(nt, { className: Pt, children: [
      /* @__PURE__ */ c(rt, { icon: e }),
      /* @__PURE__ */ c("span", { className: "flex-1", children: t }),
      /* @__PURE__ */ c("span", { className: "text-f1-foreground-secondary", children: y })
    ] }),
    /* @__PURE__ */ c(at, { container: a ?? void 0, children: /* @__PURE__ */ c(ot, { className: Me, children: /* @__PURE__ */ S(
      st,
      {
        value: m ? r ? o : ie : o,
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ c(
              "button",
              {
                ...
                children: /* @__PURE__ */ c(dt, { icon: Ce, size: "lg", color: "#fff" })
              }
            )
          }
        ),
