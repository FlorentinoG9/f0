const e = {
  ...
  meeting: {
    ...
    cameraBlocked: "Camera access is blocked. Allow it in your browser settings to turn it on.",
    microphoneBlocked: "Microphone access is blocked. Allow it in your browser settings to speak.",
    ...
    exitPictureInPicture: "Back to the tab",
    ...
    movedToFullscreen: "Meeting fills the screen",
    movedToFloating: "Meeting in a floating window",
    movedToSidePanel: "Meeting in the side panel",
    movedToMinimized: "Meeting minimized",
    movedInline: "Meeting on the page",
    movedToPictureInPicture: "Meeting in a picture-in-picture window"
  },
  select: {
